...
<table="0">
	<form method="POST"
		action="http://localhost:8080/encheres/html/PageAccueil.html"
		id="register-form">
			...
			<input type="submit" value="Créer un compte" id="creation-btn"><a href="/ServletPageAccueil" target="_blank">
						</a>

			<button id="cancel-btn"><a href="http://localhost:8080/encheres/ServletSinscrire">Annuler</a></button>
